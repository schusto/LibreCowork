...
async function finishResumableRequest(req, userId, removeElicitationListener = null) {
...
const ResumableAgentController = async (req, res, next, initializeClient, addTitle) => {
  ...
  try {
    ...
    // MCP Elicitation: forward elicitation events to the SSE stream
    ...
    if (job.abortController.signal.aborted) {
      ...
      await finishResumableRequest(req, userId, removeElicitationListener);
      return;
    }
