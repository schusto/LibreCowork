...
// [cowork] Elicitation: respond to an MCP elicitation request
export const mcpElicitationRespond = (elicitationId: string) =>
  `${BASE_URL}/api/mcp/elicitations/${elicitationId}/respond`;
