      ...
      const result = await connection.client.request(
        {
          ...
          params: {
            ...
            // Thread tool_call_id through _meta so elicitation handlers in the
            // MCP server can forward it back, avoiding a race with the shared
            // currentToolCallId field under concurrent eager tool execution.
            ...(toolCallId ? { _meta: { tool_call_id: toolCallId } } : {}),
          },
        },
