...
export const ElicitationActionSchema: z.ZodEnum<['accept', 'decline', 'cancel']> = z.enum([
  'accept',
  'decline',
  'cancel',
]);

export const ElicitationPropertySchema: z.ZodObject<{
...
export const ElicitationRequestSchemaSchema: z.ZodObject<{
  type: z.ZodLiteral<'object'>;
  properties: z.ZodRecord<z.ZodString, typeof ElicitationPropertySchema>;
...
export const ElicitationCreateRequestSchema: z.ZodObject<{
  message: z.ZodString;
  requestedSchema: typeof ElicitationRequestSchemaSchema;
}> = z.object({
  message: z.string(),
  requestedSchema: ElicitationRequestSchemaSchema,
});

export const ElicitationResponseSchema: z.ZodObject<{
  action: typeof ElicitationActionSchema;
...
export const ElicitationStateSchema: z.ZodObject<{
  id: z.ZodString;
  serverName: z.ZodString;
  userId: z.ZodString;
  request: typeof ElicitationCreateRequestSchema;
...
/** Method schema for the elicitation/create request from MCP servers */
export const ElicitationCreateMethodSchema: z.ZodObject<{
  method: z.ZodLiteral<'elicitation/create'>;
  params: typeof ElicitationCreateRequestSchema;
}> = z.object({
