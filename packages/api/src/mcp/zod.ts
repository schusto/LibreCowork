...
// [cowork] Elicitation fork: expose MCP SDK's elicitation/create schema under our canonical name
export const ElicitationCreateMethodSchema: typeof ElicitRequestSchema = ElicitRequestSchema;
